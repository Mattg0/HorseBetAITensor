...
def insert_data_into_sqlite(sqlite_db, data, columns):
    ...
    insert_query = f"INSERT OR IGNORE INTO Jokey ({', '.join(columns)}) VALUES ({placeholders})"
...
def main():
    ...
    mysql_query = "SELECT idjockey ,jockey as nom FROM cachedate;"  # Change this to your MySQL query
    ...
    if data is not None and columns is not None:
        ...
        idjockey_index = columns.index('idjockey')  # Get the index of the idche column
        unique_data = remove_duplicates(data, idjockey_index)
